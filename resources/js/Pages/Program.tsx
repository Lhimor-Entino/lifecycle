...
import { LifeCycle, Program, UserAcceptance } from '@/types';
    ...
    const handleSelect = (e:LifeCycle) =>{
        ...
        switch(e){
            ...
            case 'Requirement Traceability Matrix':
                ...
                break;
            case 'Setup Schedule': 
                if (!program.business_requirement_document){
            ...
            case 'Send an email to inform of failed test':
                ...
                for (let item of program.techinical_requirement_document.items) {
